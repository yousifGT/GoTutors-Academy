...
/**
 * DEMO PREVIEW of the action-first instructor dashboard: instead of a second
 * course list, it answers "what needs me today?" — a prioritised attention
 * panel, a live activity feed and a compact recently-updated strip. Works on
 * real data; once approved it replaces /instructor and this route goes.
 */
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-xl border border-gold/40 bg-gold/10 px-4 py-2 text-sm text-gold">
        Demo preview of the action-first dashboard — real data, nothing is modified. The current dashboard is untouched.
      </div>
