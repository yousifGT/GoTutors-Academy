...
/** Step 1 revisited for an existing draft — same form, edits in place. */
export default async function DemoDetailsPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-2xl space-y-5">
      ...
      <WizardSteps
        current={1}
        links={[null, `/instructor/courses/demo/${course.id}/curriculum`, `/instructor/courses/demo/${course.id}/review`]}
      />
      <CourseWizardDetails
