import type { Bucket, CentreSize, InspectionQuestionType } from "@prisma/client";
import {
  bucketOf,
  itemScore,
  notesRequired,
...
const BUCKET_TO_DB: Record<CoreBucket, Bucket> = {
  well: "WELL",
  improve: "IMPROVE",
  obs: "OBS",
  skip: "SKIP",
...
export function toDbBucket(b: CoreBucket): Bucket {
